...
describe('About Page', () => {
  ...
  it('Registration fails, email not entered', () => {
    ...
    registerF.Firstname = 'karishma';
    registerF.Lastname = 'yallanki';
    registerF.password = 'hiv78';
    registerF.Signup();
  ...
  it('Registration success', () => {
    ...
    registerP.Firstname = 'karishma';
    registerP.Lastname = 'yallanki';
    registerP.email = 'ky57x@mail.missouri.edu';
    registerP.password = 'hiv78';
    registerP.Signup();
    expect(alertCtrl.create).toHaveBeenCalled();
